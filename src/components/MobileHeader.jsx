...
export default function MobileHeader({ title, onBack }) {
  ...
  return (
    ...
    >
      ...
      <button
        onClick={handleBack}
        className="absolute top-0 left-0 bottom-0 flex items-end gap-0.5 pb-3 text-primary no-select active:opacity-60 transition-opacity"
        style={{ paddingTop: 'env(safe-area-inset-top, 0px)', paddingLeft: '16px', minWidth: '120px' }}
      >
